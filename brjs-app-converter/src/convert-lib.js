...
export function createBRLibPackageJSON(packageDirectory, packageName) {
...
export function convertBRLibToPackage(packageDirectory, packageName) {
...
export function convertLibToPackage(packageDirectory, packageName) {
